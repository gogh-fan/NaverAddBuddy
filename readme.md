...
1.  `run.bat` 파일을 실행합니다.
2.  프롬프트에 **검색할 키워드**를 입력하고 Enter를 누릅니다.
    *   예: `담배`
3.  크롤링할 **페이지 수**를 입력하고 Enter를 누릅니다.
    *   예: `1`
...
*   프로그램이 띄운 네이버 로그인은 수동으로 하셔야합니다.
*   Playwright 브라우저를 설치하게 됩니다.
*   C:\Users\[사용자명]\AppData\Local\ms-playwright 에 설치됩니다.
*   playwright uninstall 로 삭제할 수 있습니다만 폴더는 남습니다. 위 경로를 통해 지울 수 있습니다.
